...
app.post("/user/add_data", bodyParser.json(), (req, res) => {
   ...
   app.post("/user/updated", bodyParser.json(), (req, res) => {
   ...
   app.get("/user/results",bodyParser.json(),(req, res) =>{
   ...
   app.delete("/user/remove", bodyParser.json(), (req, res) =>{
